...
export function Hero() {
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden pt-[400px] md:pt-[370px]">
      {/* Background Elements */}
      ...
      <div className="container mx-auto px-6 relative z-10">
        <div className="max-w-5xl mx-auto text-center">
          ...
          >
            Transform your brand with stunning visuals, strategic design, and 
            creative solutions that captivate your audience and drive results.
          </motion.p>
