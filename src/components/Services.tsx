...
import { Palette, Monitor, Megaphone, Camera, Layers } from "lucide-react";
...
const services = [
  ...
  },
  {
    ...
    description: "Get your online registration done with experts assistance.",
    href: "/services/online-service",
  },
  {
    icon: Megaphone,
