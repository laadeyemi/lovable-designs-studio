...
const jobs: Job[] = [
  {
    ...
    responsibilities: ["Design end-to-end user experiences", "Mentor junior designers", "Collaborate with PMs and engineers"],
  },
  {
    id: "pm-growth",
    ...
    responsibilities: ["Define growth experiments", "Analyze funnels", "Coordinate cross-functional teams"],
  },
  {
    id: "junior-developer",
    ...
    responsibilities: ["Build accessible components", "Write tests", "Ship fast iterations"],
  },
  {
    id: "Customer Service",
